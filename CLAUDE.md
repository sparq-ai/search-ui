...
- `sparqClient.ts` is the ONLY file that may know search-API REST specifics; analytics wire knowledge lives exclusively in the `@sparq/analytics-js` dependency (ARCHITECTURE §20) — never write tracking REST calls in this repo.
